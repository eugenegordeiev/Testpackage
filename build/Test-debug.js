...
Ext.define('Test.view.MyMessageBox', {extend:'Ext.window.Window', alias:'widget.mymessagebox', modal:'true', height:Ext.getBody().getViewSize().height * 0.5, width:Ext.getBody().getViewSize().width * 0.5});
